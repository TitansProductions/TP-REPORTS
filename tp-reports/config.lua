...
Config.ServerNamePrefix       = "[MyServerName]"
...
Config.WEBHOOK                = "https://discord.com/api/webhooks/xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx/xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
